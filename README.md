...
- Задачи со сроком, описанием, привязкой к участку/зоне, напоминанием и повторами `daily`, `weekly`, `monthly`, `yearly`.
- Редактирование задач, участков и зон через кнопки.
- Справочник типовых работ и идеи задач для участка или зоны.
...
STARTUP_UPDATE_MESSAGE=Добавлены описание и место задачи, управление участками и зонами, справочник работ.
