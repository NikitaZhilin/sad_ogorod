...
Основной пользовательский слой работает через кнопки: после `/start` бот показывает меню `Сегодня`, `Новая задача`, `Все задачи`, `Огород`, `Журнал`, `Справочник`, `Настройки`, `Помощь`. В диалогах создания задачи бот принимает даты в форматах `2026-05-25 12:00`, `25.05.2026 12:00`, `25.05 12:00`, `сегодня 12:00`, `завтра 9:00`, а также предлагает быстрые варианты. Для даты посадки насаждения можно указать точную дату или только месяц: `май`, `май 2026`, `05.2026`, `2026-05`. Команды ниже сохранены для обратной совместимости и быстрого ручного администрирования.
...
STARTUP_UPDATE_MESSAGE=Улучшены главное меню, подсказки изменения даты задачи и ввод даты посадки для насаждений.
