...
Основной пользовательский слой работает через кнопки: после `/start` бот показывает меню `Задачи`, `Огород`, `Журнал`, `Настройки`, `Помощь`. В диалогах создания задачи бот принимает даты в форматах `2026-05-25 12:00`, `25.05.2026 12:00`, `25.05 12:00`, `сегодня 12:00`, `завтра 9:00`. Команды ниже сохранены для обратной совместимости и быстрого ручного администрирования.
